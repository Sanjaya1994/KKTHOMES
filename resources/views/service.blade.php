...
<header class="main-header"> 
  ...
  <section class="inner-heading">
    <div class="container">
      ...
      <ul class="xs-breadcumb">
        <li><a href="/index"> Home  / </a> <a href="/index">Pages /</a> Services</li>
      </ul>
    </div>
  </section>
  <!--inner-heading end--> 
  ...
  <div class="container">
    <div class="section-title">
      ...
      <p>The company wishes to introduce modern technologies used in the globe to 
      infrastructure construction industry in srilanka The company aims to
      diversify the business scope into potential segments in the future. </p>
    </div>
    <!--row start-->
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">House Constructions</a></h3>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">Building Constructions</a></h3>
              <p> We amongst the foremost well acknowledged construction firms in country, with a wealth of numerous expertise and exposure. Our company philosophy of trust, integrity and quality has placed us at the forefront of the development trade..</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">House Plan</a></h3>
              <p>Perhaps you have already selected a lot, but are having difficulty finding a house that fits? Deciding on the perfect design for your new home can feel overwhelming. How do you know which architect or designer will design the perfect home that suits your budget and your needs? </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">BOQ</a></h3>
              <p>
We have expanded on the variety of construction services we extend to our clients by branching into handling residential construction projects in Sri Lanka. Our residential projects feature the most elegant fittings and finishes including residential accessories that are of the highest quality</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">Consulting Works</a></h3>
              <p>Another thing to actually be able to manage everything from the house designs to the construction management of all the contractors, subcontractors, designers, and labor that’s involved in building a house – not to mention all the structural and legal issues from permits to inspections, architects, engineers, and more.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-item">
          <div class="fig_caption">
            ...
            <div class="details">
              <h3><a href="service-signle.html">Electrical Plumbing Design</a></h3>
              <p> Mechanical, electrical and plumbing (MEP) systems are an important part of building services and can have many different functions. </p>
            </div>
          </div>
        </div>
      </div>
