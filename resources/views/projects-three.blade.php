  ...
  <div class="container-fluid">
    ...
    <div class="portfolio-inner"> 
      ...
      <ul class="row container-masonry  portfolio-posts grid">
        ...
        <li class="col-md-4 col-sm-6 col-xs-12 nf-item financing marketing branding">
          <div class="serviceWrap"> <img src="images/gallery/10.jpg" alt="img-8">
            <div class="caption">
            <h3>Ongoing House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/10.jpg" title="Brand Promotion" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <li class="col-md-4 col-sm-6 col-xs-12 nf-item financing marketing branding">
          <div class="serviceWrap"> <img src="images/gallery/11.jpg" alt="img-8">
            <div class="caption">
            <h3>ongoing House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/11.jpg" title="Brand Promotion" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <li class="col-md-4 col-sm-6 col-xs-12 nf-item financing marketing branding">
          <div class="serviceWrap"> <img src="images/gallery12.jpg" alt="img-8">
            <div class="caption">
            <h3>ongoing House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/12.jpg" title="Brand Promotion" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <!--col end-->
      </ul>
