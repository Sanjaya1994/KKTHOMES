  ...
  <section class="inner-heading">
    <div class="container">
      ...
      <ul class="xs-breadcumb">
        <li><a href="/index"> Home  / </a> <a href="/index">Pages /</a> Project </li>
      </ul>
    </div>
  </section>
  <!--inner-heading end--> 
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <ul class="container-filter categories-filter">
        ...
        <li> <a class="categories hvr-link" data-filter=".branding">Single Storey House Projects </a> </li>
        <li> <a class="categories hvr-link" data-filter=".financing">Two Storey House Projects</a> </li>
        <li> <a class="categories hvr-link" data-filter=".marketing">Three Storey House Projects</a> </li>
        <li> <a class="categories hvr-link" data-filter=".promotion">Commercial Bulding Design</a> </li>
      </ul>
    </div>
    <!--row end-->
    <div class="portfolio-inner"> 
      ...
      <ul class="row container-masonry  portfolio-posts grid">
        <!--col start-->
        <li class="col-md-2 col-sm-6 col-xs-12 nf-item grid-sizer branding">
          <div class="image-hover-effect"> <img src="images/gallery/01.jpg" alt="img-1">
            <div class="caption">
              <h3>Two Storey House Projects</h3>
        ...
        <!--col end--> 
        <!--col start-->
        <li class="col-md-2 col-sm-6 col-xs-12 nf-item financing promotion">
        ...
        <!--col end--> 
        <!--col start-->
        <li class="col-md-2 col-sm-6 col-xs-12 nf-item grid-sizer marketing branding promotion">
        ...
        <!--col end--> 
        <!--col start-->
        <li class="col-md-2 col-sm-6 col-xs-12 nf-item branding marketing">
        ...
        <!--col end--> 
        <!--col start-->
        <li class="col-md-2 col-sm-6 col-xs-12 nf-item financing marketing branding">
          <div class="image-hover-effect-4"> <img src="images/gallery/05.jpg" alt="img-5">
            <div class="caption">
              <h3>Single Storey House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
        ...
        </li><li class="col-md-2 col-sm-6 col-xs-12 nf-item grid-sizer marketing branding promotion">
          <div class="image-hover-effect-2"> <img src="images/gallery/10.jpg" alt="img-3">
            <div class="caption">
            <h3>Two Storey House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
        ...
        <!--col end--> 
           <!--col start-->
           <li class="col-md-2 col-sm-6 col-xs-12 nf-item branding marketing">
          <div class="image-hover-effect-3"> <img src="images/gallery/10.jpg" alt="img-4">
            <div class="caption">
            <h3>Two Storey House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/10.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <!--col end--> 
           <!--col start-->
           <li class="col-md-2 col-sm-6 col-xs-12 nf-item branding marketing">
          <div class="image-hover-effect-3"> <img src="images/gallery/11.jpg" alt="img-4">
            <div class="caption">
            <h3>Two Storey House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/11.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <!--col end-->
           <!--col start-->
           <li class="col-md-2 col-sm-6 col-xs-12 nf-item branding marketing">
          <div class="image-hover-effect-3"> <img src="images/gallery/12.jpg" alt="img-4">
            <div class="caption">
            <h3>Two Storey House Projects</h3>
              <p>Our Ongoing Projects</p>
            </div>
            <div class="link-wrap"> <a href="images/gallery/12.jpg" title="Business Financing" class="lightbox-image"><i class="fa fa-search"></i></a> <a href="projects-single.html"><i class="fa fa-link"></i></a> </div>
          </div>
        </li>
        <!--col end-->  
      </ul>
