  ...
  <section class="inner-heading">
    <div class="container">
      ...
      <ul class="xs-breadcumb">
        <li><a href="/index"> Home  / </a> <a href="/index">Pages /</a> Our Team</li>
      </ul>
    </div>
  </section>
  <!--inner-heading end--> 
    ...
    <div class="container">
      <div class="freelance-content">
        <ul class="freelance-slider">
          <li>
            <div class="teamWrap"> <img src="images/st/CEO.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>CEO</h3>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="teamWrap"> <img src="images/st/Head of Reagulations.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>Head of Reagulations</h3>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          </li>
          <li>
          <li>
            <div class="teamWrap"> <img src="images/st/Manager-Operation.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Manager-Operation</h3>
              
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          </li>
            <div class="teamWrap"> <img src="images/st/Senior Designer.jpg" class="img-responsive" alt="img1">
              <div class="caption">
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Designer.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Designer</h3>
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Research & Development ASST.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Research & Development Assistant</h3>
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Sales Represanatative.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Sales Represanatative</h3>
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Site supervisor 2.jpg" class="img-responsive" alt="img1">
              <div class="caption">
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Site supervisor.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Site supervisor </h3>
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Tranee Draftman.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Tranee Draftman </h3>
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Finance Assistant.jpg" class="img-responsive" alt="img1">
              <div class="caption">
          ...
          <li>
            <div class="teamWrap"> <img src="images/st/Driver.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>Driver </h3>
