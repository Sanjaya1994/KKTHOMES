...
<header class="main-header"> 
                ...
                <ul class="navigation clearfix">
                  ...
                  <li class="dropdown"><a class="hvr-link" href="#">About</a>
                    <ul>
                      ...
                      <li><a class="hvr-link" href="/coming-soon">Coming-soon</a></li>
                    </ul>
                  </li>
                  ...
                  <li class="dropdown"><a class="hvr-link" href="#">Projects</a>
                    <ul>
                      <li><a class="hvr-link" href="/projects">Project</a></li>
                      <li><a class="hvr-link" href="/projects-three">Project Three Column</a></li>
  ...
  <section class="inner-heading">
    <div class="container">
      <h1>Our Charity Works</h1>
      <ul class="xs-breadcumb">
        <li><a href="/index"> Home  / </a> <a href="/index">Pages /</a> OUR CHARITY WORKS</li>
      </ul>
    </div>
  </section>
  <!--inner-heading end--> 
    ...
    <div class="container">
      <div class="freelance-content">
        <ul class="freelance-slider">
          <li>
            <div class="teamWrap"> <img src="images/3.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                <h3>KKT OBT 2016 </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          </li> <li>
            <div class="teamWrap"> <img src="images/ch/002.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>Flood Donation </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          ...
          <li>
                      <div class="teamWrap"> <img src="images/40 copy.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>RAMAZAN FESTIVAL </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          ...
          <li>
            <div class="teamWrap"> <img src="images/ch/004.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>Flood Donation </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
          ...
          <li>
          <li>
            <div class="teamWrap"> <img src="images/new2017.jpg" class="img-responsive" alt="img1">
              <div class="caption">
                 <h3>New Year Festival 2017</h3>
                <p>KKT CHARITY WORKS</p>
              </div>
              <div class="link-wrap"> <a href="#1"><i class="fa fa-facebook"></i></a> <a href="#1"><i class="fa fa-twitter"></i></a> </div>
            </div>
          </li>
            <div class="teamWrap"> <img src="images/19.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>KKT OBT 2016 </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
          ...
          <li>
            <div class="teamWrap"> <img src="images/ch/003.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>Flood Donation </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
          ...
          <li>
            <div class="teamWrap"> <img src="images/9.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>RAMAZAN FESTIVAL </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
          ...
          <li>
            <div class="teamWrap"> <img src="images/2015new.JPG" class="img-responsive" alt="img1">
              <div class="caption">
          ...
          <li>
            <div class="teamWrap"> <img src="images/ch/001.jpg" class="img-responsive" alt="img1">
              <div class="caption">
              <h3>Flood Donation </h3>
                <p>KKT CHARITY WORKS</p>
              </div>
